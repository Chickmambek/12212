...
class Profile(models.Model):
    ...
    default_stake = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal('10.00'), help_text="Default stake amount for quick bets")
...
class Proxy(models.Model):
    ...
    def _parse_raw_proxy_string(self):
        ...
        try:
            ...
            print(f"Error parsing proxy string: {str(e)}")

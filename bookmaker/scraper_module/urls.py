...
urlpatterns = [
    ...
    path('livescraperstatus/control_live/start/', views.start_live_scraper, name='start_scraper'),
    path('livescraperstatus/control_live/stop/', views.stop_live_scraper, name='stop_scraper'),
    path('livescraperstatus/logs_live/', views.get_live_scraper_logs, name='get_scraperlogs'),
